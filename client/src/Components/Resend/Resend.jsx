                ...
                <Col className='form-right-box' lg={7}>
                    <Form onSubmit={handleClick}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="email" placeholder="Enter email" name='email' value={user.email} onChange={handleChange} className='form-input bg-transparent px-0 py-2' />
                            <span className='text-danger'></span>
                        </Form.Group>

                        <Form.Group className="mb-3">
                            <Form.Label>OTP</Form.Label>
                            <Form.Control type="text" placeholder="Enter OTP" name='otp' value={user.otp} onChange={handleChange} className='form-input bg-transparent px-0 py-2' />
                            <span className='text-danger'></span>
                        </Form.Group>

                        <Form.Group className="mb-3">
                            <Form.Label>New Password</Form.Label>
                            <Form.Control type="password" placeholder="Enter New Password" name='password' value={user.password} onChange={handleChange} className='form-input bg-transparent px-0 py-2' />
                            <span className='text-danger'></span>
                        </Form.Group>
                        ...
                        <div className="nav-links d-flex justify-content-between">
                            <Link to='/login' className='cursor-pointer text-primary'>Back to Login</Link>
                        </div>
                    </Form>
                </Col>
            </Row>
