...
const Login = () => {
  ...
  const handleClick = async (e) => {
    try {
      ...
      const response = await fetch(
        "https://electronicstore.onrender.com/api/v1/login",
        {
          method: "POST",
          headers: {
  ...
  const forgotPass = async () => {
    try {
      const response = await fetch(
        "https://electronicstore.onrender.com/api/v1/opt-service",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const resendMail = async () => {
    try {
      const response = await fetch(
        "https://electronicstore.onrender.com/api/v1/resend-mail",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <Row className="form-box">
        ...
        <Col className="form-right-box login" lg={7}>
          <Form onSubmit={handleClick}>
            ...
            <h6
              className="text-primary text-decoration-underline text-end"
